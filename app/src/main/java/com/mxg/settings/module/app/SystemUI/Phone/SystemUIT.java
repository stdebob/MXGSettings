...
package com.mxg.settings.module.app.SystemUI.Phone;

import static com.mxg.settings.utils.api.OldFunApisKt.isNewNetworkStyle;
...
import com.mxg.settings.module.hook.systemui.AllowManageAllNotifications;
import com.mxg.settings.module.hook.systemui.AutoCollapse;
import com.mxg.settings.module.hook.systemui.BluetoothRestrict;
import com.mxg.settings.module.hook.systemui.BrightnessPct;
import com.mxg.settings.module.hook.systemui.ChargeAnimationStyle;
import com.mxg.settings.module.hook.systemui.DisableBottomBar;
import com.mxg.settings.module.hook.systemui.DisableInfinitymodeGesture;
import com.mxg.settings.module.hook.systemui.DisableMiuiMultiWinSwitch;
import com.mxg.settings.module.hook.systemui.DisableTransparent;
import com.mxg.settings.module.hook.systemui.MediaButton;
import com.mxg.settings.module.hook.systemui.MediaSeekBarColor;
import com.mxg.settings.module.hook.systemui.MonetThemeOverlay;
import com.mxg.settings.module.hook.systemui.NotificationFix;
import com.mxg.settings.module.hook.systemui.NotificationFreeform;
import com.mxg.settings.module.hook.systemui.QSDetailBackGround;
import com.mxg.settings.module.hook.systemui.RemoveMiuiMultiWinSwitch;
import com.mxg.settings.module.hook.systemui.SquigglyProgress;
import com.mxg.settings.module.hook.systemui.StatusBarActions;
import com.mxg.settings.module.hook.systemui.StickyFloatingWindowsForSystemUI;
import com.mxg.settings.module.hook.systemui.UiLockApp;
import com.mxg.settings.module.hook.systemui.UnimportantNotification;
import com.mxg.settings.module.hook.systemui.UnlockClipboard;
import com.mxg.settings.module.hook.systemui.UnlockCustomActions;
import com.mxg.settings.module.hook.systemui.controlcenter.AddBlurEffectToNotificationView;
import com.mxg.settings.module.hook.systemui.controlcenter.AllowAllThemesNotificationBlur;
import com.mxg.settings.module.hook.systemui.controlcenter.CCGrid;
import com.mxg.settings.module.hook.systemui.controlcenter.CompactNotificationsHook;
import com.mxg.settings.module.hook.systemui.controlcenter.ControlCenterStyle;
import com.mxg.settings.module.hook.systemui.controlcenter.DisableDeviceManaged;
import com.mxg.settings.module.hook.systemui.controlcenter.ExpandNotification;
import com.mxg.settings.module.hook.systemui.controlcenter.FiveGTile;
import com.mxg.settings.module.hook.systemui.controlcenter.FixTilesList;
import com.mxg.settings.module.hook.systemui.controlcenter.FlashLight;
import com.mxg.settings.module.hook.systemui.controlcenter.GmsTile;
import com.mxg.settings.module.hook.systemui.controlcenter.HideDelimiter;
import com.mxg.settings.module.hook.systemui.controlcenter.MediaControlPanelBackgroundMix;
import com.mxg.settings.module.hook.systemui.controlcenter.MediaControlPanelTimeViewTextSize;
import com.mxg.settings.module.hook.systemui.controlcenter.MediaControlSeekbarCustom;
import com.mxg.settings.module.hook.systemui.controlcenter.MuteVisibleNotifications;
import com.mxg.settings.module.hook.systemui.controlcenter.NotificationImportanceHyperOSFix;
import com.mxg.settings.module.hook.systemui.controlcenter.NotificationRowMenu;
import com.mxg.settings.module.hook.systemui.controlcenter.NotificationWeather;
import com.mxg.settings.module.hook.systemui.controlcenter.NotificationWeatherNew;
import com.mxg.settings.module.hook.systemui.controlcenter.NotificationWeatherOld;
import com.mxg.settings.module.hook.systemui.controlcenter.QQSGrid;
import com.mxg.settings.module.hook.systemui.controlcenter.QSColor;
import com.mxg.settings.module.hook.systemui.controlcenter.QSControlDetailBackgroundAlpha;
import com.mxg.settings.module.hook.systemui.controlcenter.QSGrid;
import com.mxg.settings.module.hook.systemui.controlcenter.QSGridLabels;
import com.mxg.settings.module.hook.systemui.controlcenter.RedirectToNotificationChannelSetting;
import com.mxg.settings.module.hook.systemui.controlcenter.ReduceBrightColorsTile;
import com.mxg.settings.module.hook.systemui.controlcenter.SunlightMode;
import com.mxg.settings.module.hook.systemui.controlcenter.SwitchCCAndNotification;
import com.mxg.settings.module.hook.systemui.controlcenter.TaplusTile;
import com.mxg.settings.module.hook.systemui.lockscreen.AddBlurEffectToLockScreen;
import com.mxg.settings.module.hook.systemui.lockscreen.AllowThirdLockScreenUseFace;
import com.mxg.settings.module.hook.systemui.lockscreen.BlockEditor;
import com.mxg.settings.module.hook.systemui.lockscreen.BlurButton;
import com.mxg.settings.module.hook.systemui.lockscreen.ChargingCVP;
import com.mxg.settings.module.hook.systemui.lockscreen.ClockDisplaySeconds;
import com.mxg.settings.module.hook.systemui.lockscreen.DisableUnlockByBleToast;
import com.mxg.settings.module.hook.systemui.lockscreen.ForceClockUseSystemFontsHook;
import com.mxg.settings.module.hook.systemui.lockscreen.HideLockScreenHint;
import com.mxg.settings.module.hook.systemui.lockscreen.HideLockScreenStatusBar;
import com.mxg.settings.module.hook.systemui.lockscreen.HideLockscreenZenMode;
import com.mxg.settings.module.hook.systemui.lockscreen.LockScreenDoubleTapToSleep;
import com.mxg.settings.module.hook.systemui.lockscreen.NoPassword;
import com.mxg.settings.module.hook.systemui.lockscreen.RemoveCamera;
import com.mxg.settings.module.hook.systemui.lockscreen.RemoveSmartScreen;
import com.mxg.settings.module.hook.systemui.lockscreen.ScramblePIN;
import com.mxg.settings.module.hook.systemui.navigation.HandleLineCustom;
import com.mxg.settings.module.hook.systemui.navigation.HideNavigationBar;
import com.mxg.settings.module.hook.systemui.navigation.NavigationCustom;
import com.mxg.settings.module.hook.systemui.navigation.RotationButton;
import com.mxg.settings.module.hook.systemui.plugin.PluginHelper;
import com.mxg.settings.module.hook.systemui.statusbar.BlurEnable;
import com.mxg.settings.module.hook.systemui.statusbar.DoubleTapToSleep;
import com.mxg.settings.module.hook.systemui.statusbar.HideStatusBarBeforeScreenshot;
import com.mxg.settings.module.hook.systemui.statusbar.NotificationIconColumns;
import com.mxg.settings.module.hook.systemui.statusbar.SelectiveHideIconForAlarmClock;
import com.mxg.settings.module.hook.systemui.statusbar.WifiStandard;
import com.mxg.settings.module.hook.systemui.statusbar.clock.DisableAnim;
import com.mxg.settings.module.hook.systemui.statusbar.clock.FixColor;
import com.mxg.settings.module.hook.systemui.statusbar.clock.StatusBarClockNew;
import com.mxg.settings.module.hook.systemui.statusbar.clock.TimeCustomization;
import com.mxg.settings.module.hook.systemui.statusbar.clock.TimeStyle;
import com.mxg.settings.module.hook.systemui.statusbar.device.DisplayHardwareDetail;
import com.mxg.settings.module.hook.systemui.statusbar.icon.all.BatteryStyle;
import com.mxg.settings.module.hook.systemui.statusbar.icon.all.BluetoothIcon;
import com.mxg.settings.module.hook.systemui.statusbar.icon.all.DataSaverIcon;
import com.mxg.settings.module.hook.systemui.statusbar.icon.all.HideBatteryIcon;
import com.mxg.settings.module.hook.systemui.statusbar.icon.all.HideVoWiFiIcon;
import com.mxg.settings.module.hook.systemui.statusbar.icon.all.IconsFromSystemManager;
import com.mxg.settings.module.hook.systemui.statusbar.icon.all.StatusBarIcon;
import com.mxg.settings.module.hook.systemui.statusbar.icon.all.StatusBarIconPositionAdjust;
import com.mxg.settings.module.hook.systemui.statusbar.icon.all.StatusBarSimIcon;
import com.mxg.settings.module.hook.systemui.statusbar.icon.all.WifiNetworkIndicator;
import com.mxg.settings.module.hook.systemui.statusbar.icon.t.UseNewHD;
import com.mxg.settings.module.hook.systemui.statusbar.layout.StatusBarLayout;
import com.mxg.settings.module.hook.systemui.statusbar.model.DualRowSignalHook;
import com.mxg.settings.module.hook.systemui.statusbar.model.MobileNetwork;
import com.mxg.settings.module.hook.systemui.statusbar.model.MobilePublicHook;
import com.mxg.settings.module.hook.systemui.statusbar.model.MobileTypeSingleHook;
import com.mxg.settings.module.hook.systemui.statusbar.model.MobileTypeTextCustom;
import com.mxg.settings.module.hook.systemui.statusbar.network.NetworkSpeedSec;
import com.mxg.settings.module.hook.systemui.statusbar.network.NetworkSpeedSpacing;
import com.mxg.settings.module.hook.systemui.statusbar.network.news.NewNetworkSpeed;
import com.mxg.settings.module.hook.systemui.statusbar.network.news.NewNetworkSpeedStyle;
import com.mxg.settings.module.hook.systemui.statusbar.network.old.NetworkSpeed;
import com.mxg.settings.module.hook.systemui.statusbar.network.old.NetworkSpeedStyle;
import com.mxg.settings.module.hook.systemui.statusbar.network.old.StatusBarNoNetSpeedSep;
import com.mxg.settings.module.hook.systemui.statusbar.network.s.NetworkSpeedWidth;
import com.mxg.settings.module.hook.systemui.statusbar.strongtoast.HideStrongToast;
