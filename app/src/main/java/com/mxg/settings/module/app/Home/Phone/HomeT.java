 ...
 */
package com.mxg.settings.module.app.Home.Phone;
...
import com.mxg.settings.module.hook.home.AnimDurationRatio;
import com.mxg.settings.module.hook.home.FreeFormCountForHome;
import com.mxg.settings.module.hook.home.HomePortraitReverse;
import com.mxg.settings.module.hook.home.LockApp;
import com.mxg.settings.module.hook.home.MaxFreeForm;
import com.mxg.settings.module.hook.home.ScreenSwipe;
import com.mxg.settings.module.hook.home.SeekPoints;
import com.mxg.settings.module.hook.home.SetDeviceLevel;
import com.mxg.settings.module.hook.home.StickyFloatingWindowsForHome;
import com.mxg.settings.module.hook.home.ToastSlideAgain;
import com.mxg.settings.module.hook.home.UnlockHotseatIcon;
import com.mxg.settings.module.hook.home.UserPresentAnimation;
import com.mxg.settings.module.hook.home.WidgetCornerRadius;
import com.mxg.settings.module.hook.home.dock.DisableRecentsIcon;
import com.mxg.settings.module.hook.home.dock.DockCustom;
import com.mxg.settings.module.hook.home.dock.DockCustomNew;
import com.mxg.settings.module.hook.home.dock.FoldDeviceDock;
import com.mxg.settings.module.hook.home.dock.FoldDock;
import com.mxg.settings.module.hook.home.dock.HideDock;
import com.mxg.settings.module.hook.home.dock.ShowDockIconTitle;
import com.mxg.settings.module.hook.home.dock.SlideUpOnlyShowDock;
import com.mxg.settings.module.hook.home.drawer.AllAppsContainerViewBlur;
import com.mxg.settings.module.hook.home.drawer.AllAppsContainerViewSuperBlur;
import com.mxg.settings.module.hook.home.drawer.AppDrawer;
import com.mxg.settings.module.hook.home.drawer.PinyinArrangement;
import com.mxg.settings.module.hook.home.folder.BigFolderIcon;
import com.mxg.settings.module.hook.home.folder.BigFolderIconBlur;
import com.mxg.settings.module.hook.home.folder.BigFolderIconBlur1x2;
import com.mxg.settings.module.hook.home.folder.BigFolderIconBlur2x1;
import com.mxg.settings.module.hook.home.folder.BigFolderItemMaxCount;
import com.mxg.settings.module.hook.home.folder.FolderAnimation;
import com.mxg.settings.module.hook.home.folder.FolderAutoClose;
import com.mxg.settings.module.hook.home.folder.FolderBlur;
import com.mxg.settings.module.hook.home.folder.FolderColumns;
import com.mxg.settings.module.hook.home.folder.FolderShade;
import com.mxg.settings.module.hook.home.folder.FolderVerticalPadding;
import com.mxg.settings.module.hook.home.folder.SmallFolderIconBlur;
import com.mxg.settings.module.hook.home.folder.UnlockBlurSupported;
import com.mxg.settings.module.hook.home.gesture.CornerSlide;
import com.mxg.settings.module.hook.home.gesture.DoubleTap;
import com.mxg.settings.module.hook.home.gesture.HotSeatSwipe;
import com.mxg.settings.module.hook.home.gesture.QuickBack;
import com.mxg.settings.module.hook.home.gesture.ShakeDevice;
import com.mxg.settings.module.hook.home.layout.HotSeatsHeight;
import com.mxg.settings.module.hook.home.layout.HotSeatsMarginBottom;
import com.mxg.settings.module.hook.home.layout.HotSeatsMarginTop;
import com.mxg.settings.module.hook.home.layout.SearchBarMarginBottom;
import com.mxg.settings.module.hook.home.layout.UnlockGrids;
import com.mxg.settings.module.hook.home.layout.WorkspacePadding;
import com.mxg.settings.module.hook.home.mipad.EnableHideGestureLine;
import com.mxg.settings.module.hook.home.mipad.EnableMoreSetting;
import com.mxg.settings.module.hook.home.navigation.BackGestureAreaHeight;
import com.mxg.settings.module.hook.home.navigation.BackGestureAreaWidth;
import com.mxg.settings.module.hook.home.navigation.HideNavigationBar;
import com.mxg.settings.module.hook.home.other.AllowShareApk;
import com.mxg.settings.module.hook.home.other.AlwaysBlurWallpaper;
import com.mxg.settings.module.hook.home.other.AlwaysShowStatusClock;
import com.mxg.settings.module.hook.home.other.BlurRadius;
import com.mxg.settings.module.hook.home.other.BlurWhenShowShortcutMenu;
import com.mxg.settings.module.hook.home.other.DisableHideGoogle;
import com.mxg.settings.module.hook.home.other.FreeformShortcutMenu;
import com.mxg.settings.module.hook.home.other.HomeMode;
import com.mxg.settings.module.hook.home.other.InfiniteScroll;
import com.mxg.settings.module.hook.home.other.OverlapMode;
import com.mxg.settings.module.hook.home.other.ShortcutItemCount;
import com.mxg.settings.module.hook.home.other.ShowAllHideApp;
import com.mxg.settings.module.hook.home.other.TasksShortcutMenu;
import com.mxg.settings.module.hook.home.recent.AlwaysShowCleanUp;
import com.mxg.settings.module.hook.home.recent.BackgroundBlur;
import com.mxg.settings.module.hook.home.recent.BlurLevel;
import com.mxg.settings.module.hook.home.recent.CardTextColor;
import com.mxg.settings.module.hook.home.recent.CardTextSize;
import com.mxg.settings.module.hook.home.recent.DisableRecentViewWallpaperDarken;
import com.mxg.settings.module.hook.home.recent.FreeformCardBackgroundColor;
import com.mxg.settings.module.hook.home.recent.HideCleanUp;
import com.mxg.settings.module.hook.home.recent.HideFreeform;
import com.mxg.settings.module.hook.home.recent.HideStatusBarWhenEnterRecent;
import com.mxg.settings.module.hook.home.recent.MemInfoShow;
import com.mxg.settings.module.hook.home.recent.RealMemory;
import com.mxg.settings.module.hook.home.recent.RecentResource;
import com.mxg.settings.module.hook.home.recent.RecentText;
import com.mxg.settings.module.hook.home.recent.RemoveCardAnim;
import com.mxg.settings.module.hook.home.recent.RemoveIcon;
import com.mxg.settings.module.hook.home.recent.RemoveLeftShare;
import com.mxg.settings.module.hook.home.recent.ShowLaunch;
import com.mxg.settings.module.hook.home.recent.TaskViewHorizontal;
import com.mxg.settings.module.hook.home.recent.TaskViewVertical;
import com.mxg.settings.module.hook.home.recent.UnlockPin;
import com.mxg.settings.module.hook.home.title.AnimParamCustom;
import com.mxg.settings.module.hook.home.title.AppBlurAnim;
import com.mxg.settings.module.hook.home.title.BigIconCorner;
import com.mxg.settings.module.hook.home.title.DisableHideFile;
import com.mxg.settings.module.hook.home.title.DisableHideTheme;
import com.mxg.settings.module.hook.home.title.DownloadAnimation;
import com.mxg.settings.module.hook.home.title.EnableIconMonetColor;
import com.mxg.settings.module.hook.home.title.EnableIconMonoChrome;
import com.mxg.settings.module.hook.home.title.FakeNonDefaultIcon;
import com.mxg.settings.module.hook.home.title.FixAnimation;
import com.mxg.settings.module.hook.home.title.HiddenAllTitle;
import com.mxg.settings.module.hook.home.title.HideReportText;
import com.mxg.settings.module.hook.home.title.IconTitleColor;
import com.mxg.settings.module.hook.home.title.IconTitleCustomization;
import com.mxg.settings.module.hook.home.title.LargeIconCornerRadius;
import com.mxg.settings.module.hook.home.title.NewInstallIndicator;
import com.mxg.settings.module.hook.home.title.PerfectIcon;
import com.mxg.settings.module.hook.home.title.RecommendAppsSwitch;
import com.mxg.settings.module.hook.home.title.TitleFontSize;
import com.mxg.settings.module.hook.home.title.TitleMarquee;
import com.mxg.settings.module.hook.home.widget.AllWidgetAnimation;
import com.mxg.settings.module.hook.home.widget.AllowMoveAllWidgetToMinus;
import com.mxg.settings.module.hook.home.widget.AlwaysShowMiuiWidget;
import com.mxg.settings.module.hook.home.widget.HideWidgetTitles;
import com.mxg.settings.module.hook.home.widget.ResizableWidgets;
